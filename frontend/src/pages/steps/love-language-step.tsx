...
const loveStyleOptions: Option[] = [
    {
        value: "ThoughtfulGestures",
        title: "Турботливі вчинки",
    },
    {
        value: "Presents",
        title: "Подарунки",
...
interface Props {
    currentStep: number
    totalSteps: number
    value: LoveStyle | string | null
    onChange: (val: LoveStyle | null) => void
    onNext: () => void
    onBack?: () => void
    isLoading?: boolean
}
